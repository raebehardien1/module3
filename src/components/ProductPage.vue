<template>
    <div v-if="product" class="product-details">
      ...
      <p class="category">Category ID: {{ product.category_id }}</p>
  ...
  // Fetch the product from Vuex store
  const product = computed(() => store.state.products.find(p => p.product_id === productId.value));
